...
public:
    enum ApdaterInfo
    {
        WaitData         = 0, //!< Данные пришли не полностью
        EndNameRead      = 1, //!< Имя файла успешно получено
        EndFileWriting   = 2, //!< Файл успешно записан
        FileOpenError    = 3, //!< Ошибка открытия файла
        ReadStreamError  = 4, //!< Ошибка чтения из сокета
        WriteStreamError = 5  //!< Ошибка записи в файл
    };
